...
class RegistryState:
    ...
    def with_network_id(self, network_id: str) -> RegistryState:

        """Return a new state identical to this one but with the given network_id."""

        return replace(self, network_id=network_id)
